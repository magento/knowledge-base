...
labels: QPT patches,Quality Patches Tool,Support Tools,Magento,Adobe Commerce,cloud infrastructure,on-premises,QPT 1.1.18,
---
...
Two order confirmation emails are sent after placing an order from Admin.
