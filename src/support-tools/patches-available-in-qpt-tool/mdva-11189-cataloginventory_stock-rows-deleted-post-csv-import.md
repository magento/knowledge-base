 ...
 **The patch is created for Magento version:** Adobe Commerce on cloud infrastructure 2.2.3

 **Compatible with Magento versions:** Adobe Commerce (all deployment methods) 2.3.0-2.3.4-p2
