...
1. Create two store_view (test1, test2) for the default store.
1. Create a new website or store or storeview (test3).
1. Create a customer for the new website in the table customer_entity for a newly created customer website_id = 2.
