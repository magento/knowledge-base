---
title: "MDVA-42645: Admin cannot refund reward points if the store credit functionality is disabled"
...
1. Create new customer account and add some reward points.
1. Disable Store Credit Functionality by going to **Store** > Settings > **Configuration** > **Customer** > **Customer Configuration** > **Store Credit Options**.
...
* Reward points were refunded successfully.
