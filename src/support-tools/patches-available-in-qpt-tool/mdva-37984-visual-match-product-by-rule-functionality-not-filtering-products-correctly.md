---
title: 'MDVA-37984: “Match product by rule” functionality not filtering products correctly'
...
The MDVA-37984 patch solves the issue where visual merchandiser's “Match product by rule” functionality does not filter products correctly with staging updates. This patch is available when the [Quality Patches Tool (QPT)](https://support.magento.com/hc/en-us/articles/360047139492) 1.1.9 is installed. The patch ID is MDVA-37984. Please note that the issue is scheduled to be fixed in Adobe Commerce 2.4.5.
...
Visual merchandiser's “Match product by rule” functionality does not filter products correctly with staging updates.
...
1. Now select "Quantity" as the attribute, operator "Greater than" and value "4500".
1. Click **save**.
