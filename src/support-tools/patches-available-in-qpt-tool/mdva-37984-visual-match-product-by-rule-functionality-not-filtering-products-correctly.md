...
Visual Merchandiser's “Match product by rule” functionality does not filter products correctly when staging updates are applied.

**Here we are talking about products that have some staging updates applied**
