...
1. Set the Display Out of Stock Products setting in the Commerce Admin by going to > **Stores** > **Configuration** > **Catalog** > **Inventory** and set the Stock Option to **Yes**.
