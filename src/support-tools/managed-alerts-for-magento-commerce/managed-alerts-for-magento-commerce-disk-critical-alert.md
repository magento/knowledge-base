...
labels: Magento Commerce Cloud,New Relic,Pro,alert,critical,disk space,how to,maintenance mode,mysql disk space,threshold,troubleshooting,Adobe Commerce,cloud infrastructure,pro
---
...
1. In New Relic, review disks for highest use. For steps refer to Storage tab on New Relic [Infrastructure monitoring Hosts page:](https://docs.newrelic.com/docs/infrastructure/infrastructure-ui-pages/infrastructure-ui/infrastructure-hosts-page)
    ...
    * Optimizing disk space by adjusting space allocation. For steps, refer to developer documentation [Cloud for Adobe Commerce > Manage Disk space](https://devdocs.magento.com/cloud/project/manage-disk-space.html). You may also need to request more disk space (contact your CSM).
