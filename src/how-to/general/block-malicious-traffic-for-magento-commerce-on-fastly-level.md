---
title: Block malicious traffic for Magento Commerce on Fastly level
labels: .
---
...
## [None](#get-access-to-admin-panel) Get access to Admin Panel
...
## [None](#block-traffic-by-ip) Block traffic by IP
...
## [None](#block-traffic-by-country) Block traffic by country
...
## [None](#block-traffic-by-user-agent) Block traffic by user agent
...
## [None](#rate-limiting-experimental-fastly-functionality) Rate Limiting (experimental Fastly functionality)
...
## [None](#recommended-consider-updating-robottxt) Recommended: consider updating robot.txt
