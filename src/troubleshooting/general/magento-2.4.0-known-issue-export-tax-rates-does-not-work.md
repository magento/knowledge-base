...
labels: 2.4.0,Magento Commerce,Magento Commerce Cloud,button,export tax rates,known issues,troubleshooting,Adobe Commerce,cloud infrastructure
---
...
1. Click on the text of the **Export Tax Rates** button.    ![magento_export_tax_rates.png](assets/mceclip0.png)    
 ...
 <ins>Expected result</ins> : A `tax_rates.csv` file downloads containing tax rates.

 <ins>Actual result</ins> : No .csv file is downloaded.
