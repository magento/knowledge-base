...
--------------------------------------------------------------------------------------
 ...
 The following table summarizes support channels and availability for WAF Support:
    ...
    Support offering Details   Online self-service help Unlimited access   Availability for incident reports 24/7   Web portal Available via Zendesk   Emergency escalation* US toll-free: (877)-282-7436; International: (310)-945-1310    ** Magento's toll-free Support telephone line is reserved for Priority 1 Incidents only. Non-Priority 1 calls will slow down overall response to issues*
