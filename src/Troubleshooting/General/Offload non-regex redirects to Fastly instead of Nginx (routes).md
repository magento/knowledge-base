...
<p>First, you can use <a href="https://devdocs.magento.com/guides/v2.3/cloud/cdn/cloud-vcl-custom-snippets.html" target="_self">VCL snippets in Magento</a>&nbsp;to define an edge dictionary. This will contain the redirects.</p>
<p>Some caveats to this:</p>
<ul>
<li>Fastly cannot do regex on dictionary entries. It's only exact match. For more on these limitations, please see <a href="https://docs.fastly.com/guides/edge-dictionaries/about-edge-dictionaries#limitations-and-considerations" target="_self">Fastly's docs on edge dictionary limitations</a>.</li>
...
*   <a href="https://docs.fastly.com/vcl/" target="_self">Fastly VCL reference</a>
*   <a href="https://devdocs.magento.com/guides/v2.3/cloud/project/project-conf-files_routes.html" target="_self">Configure routes</a>
*   <a href="https://devdocs.magento.com/guides/v2.3/cloud/cdn/configure-fastly.html" target="_self">Set up Fastly</a>
*   <a href="https://docs.fastly.com/en/guides/vcl-regular-expression-cheat-sheet" target="_self">VCL regular expression cheat sheet</a>